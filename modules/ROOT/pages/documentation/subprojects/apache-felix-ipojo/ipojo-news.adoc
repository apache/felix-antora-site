=  iPOJO-news Excerpt: _iPOJO Manipulator (1.12.1) and Runtime (1.12.1)_ are now available in the http://felix.apache.org/downloads.cgi[downloads] section and from the Maven repository.
(December 24, 2014)
