...
## 2026
* Apache Felix CM Json 2.0.8 (June 22nd, 2026)
** https://issues.apache.org/jira/browse/FELIX-6835 CommentRemovingReader incorrectly handles escaped quotes and drops characters at buffer boundaries
...
** https://issues.apache.org/jira/browse/FELIX-6823 Fix unrecoverable Jetty state after NPE in WhiteboardManager shutdown
** https://issues.apache.org/jira/browse/FELIX-6824 Fix JMX MBean leak during Jetty restart cycle
...
* Apache Felix Http Jetty12 1.1.8 and Maven Bundle Plugin 6.0.2 (Febuary 27th, 2026)
...
** https://issues.apache.org/jira/browse/FELIX-6814 Use project.build.outputTimestamp's value for -reproducible instruction
...
** https://issues.apache.org/jira/browse/FELIX-6808 Add ability to configure Jetty12 acceptQueueSize
** https://issues.apache.org/jira/browse/FELIX-6809 Correct response/request size limit defaults to reflect unlimited
